...
const CreateUser = ({ open, setOpen, scroll }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const nextErrors = {
      firstName: employeeData.firstName.trim() ? "" : "First name is required",
      lastName: employeeData.lastName.trim() ? "" : "Last name is required",
      username: employeeData.username.trim() ? "" : "Username is required",
      password: employeeData.password.trim() ? "" : "Password is required",
      phone: employeeData.phone.toString().trim() ? "" : "Phone is required",
    };
