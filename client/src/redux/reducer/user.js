        ...
        updateUserReducer: (state, action) => {
            switch (action.payload.role) {
                case 'client':
                    ...
                    state.allClients = state.allClients.map(c => c = c._id == action.payload._id ? action.payload : c)
                    break;
                case 'employee':
                    state.employees = state.employees.map(e => e = e._id == action.payload._id ? action.payload : e)
                    state.allEmployees = state.allEmployees.map(e => e = e._id == action.payload._id ? action.payload : e)
                    break;
                default:
                    break;
            }
        ...
        deleteUserReducer: (state, action) => {
            switch (action.payload.role) {
                case 'client':
                    ...
                    state.allClients = state.allClients.filter(c => c._id != action.payload._id)
                    break;
                case 'employee':
                    state.employees = state.employees.filter(e => e._id != action.payload._id)
                    state.allEmployees = state.allEmployees.filter(e => e._id != action.payload._id)
                    break;
                default:
                    break;
            }
